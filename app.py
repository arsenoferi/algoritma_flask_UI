...
def index():
    ...
    stats = {
        ...
        'most_categories' : top_category.xs(0)['Category'],
        'total': top_category.xs(0)['Jumlah'],
        ...
        'rev_table' : df2[['Category','App','Reviews','Rating']].sort_values('Reviews',ascending=False).head(10).reset_index(drop=True).to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
